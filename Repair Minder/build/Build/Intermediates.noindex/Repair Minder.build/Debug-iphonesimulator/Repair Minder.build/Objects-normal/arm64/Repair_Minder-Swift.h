...
#ifndef REPAIR_MINDER_SWIFT_H
#define REPAIR_MINDER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Repair_Minder",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13Repair_Minder11AppDelegate")
...
SWIFT_CLASS("_TtC13Repair_Minder19CameraPreviewUIView")
...
SWIFT_CLASS("_TtC13Repair_Minder16ScannerViewModel")
...
@interface ScannerViewModel (SWIFT_EXTENSION(Repair_Minder)) <AVCaptureMetadataOutputObjectsDelegate>
